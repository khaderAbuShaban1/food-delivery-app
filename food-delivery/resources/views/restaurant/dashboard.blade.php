...
<div class="row g-4">
        ...
        <div class="glass-card stat-card p-4">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <h2 class="mb-0" style="font-size: 2rem; font-weight: 700; color: var(--accent-primary);">{{ $ordersCount }}</h2>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="glass-card stat-card p-4">
            <div class="d-flex align-items-center gap-3">
                <div style="width: 56px; height: 56px; background: {{ $restaurant && $restaurant->is_open ? 'rgba(34, 197, 94, 0.15)' : 'rgba(239, 68, 68, 0.15)' }}; border-radius: 14px; display: flex; align-items: center; justify-content: center;">
                    <i class="bi bi-toggle-on" style="font-size: 1.5rem; color: {{ $restaurant && $restaurant->is_open ? '#22C55E' : '#EF4444' }};"></i>
                </div>
                <div>
                    <p class="mb-0" style="color: var(--text-secondary); font-size: 0.85rem;">الحالة</p>
                    <h2 class="mb-0" style="font-size: 1.5rem; font-weight: 700; color: {{ $restaurant && $restaurant->is_open ? '#22C55E' : '#EF4444' }};">
    ...
    <div class="col-md-6">
        <div class="glass-card p-4">
            <h5 class="mb-4" style="color: var(--text-secondary); font-weight: 600;">
                <i class="bi bi-graph-up me-2" style="color: var(--accent-primary);"></i>إحصائيات سريعة
            </h5>
            ...
            <div class="d-flex justify-content-between align-items-center py-3">
                ...
                <span class="badge {{ $restaurant && $restaurant->is_open ? 'badge-open' : 'badge-closed' }}">
                    {{ $restaurant && $restaurant->is_open ? 'يقبل الطلبات' : 'لا يقبل' }}
                </span>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="glass-card p-4">
            ...
            <div class="d-grid gap-3">
                <a href="{{ route('restaurant.menu') }}" class="btn btn-orange d-flex align-items-center justify-content-center gap-2">
                    <i class="bi bi-plus-circle"></i>إضافة صنف جديد
                </a>
                <a href="{{ route('restaurant.orders') }}" class="btn btn-outline d-flex align-items-center justify-content-center gap-2">
