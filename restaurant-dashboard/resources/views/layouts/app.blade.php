    ...
    <style>
        ...
        * {
        ...
        @media (max-width: 768px) {
            ...
            .sidebar { position: fixed; left: 0; transform: translateX(-100%); width: var(--sidebar-width); transition: transform 0.3s; }
            .sidebar.show { transform: translateX(0); }
            .main-content { grid-column: 1; margin-top: 0; }
        }
...
<body>
    <div class="dashboard-layout">
        ...
        <aside class="sidebar">
            <div class="sidebar-brand">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <span class="badge {{ $restaurant['is_open'] ? 'badge-open' : 'badge-closed' }}" style="font-size: 0.65rem;">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="/menu" class="sidebar-link {{ request()->is('menu') ? 'active' : '' }}">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Remove any duplicate modals from DOM
            const modals = {};
            document.querySelectorAll('[id^="editMenuModal"], [id^="statusModal"]').forEach(function(el) {
                const id = el.id;
                if (modals[id]) {
                    el.remove();
                } else {
